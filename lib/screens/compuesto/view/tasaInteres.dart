...
class _TasaInteresState extends State<TasaInteres> {
  ...
  void _calculateInterestRate() {
    if (_formKey.currentState!.validate()) {
      ...
      if (capital <= 0 || montoFuturo <= 0) {
        _showErrorSnackbar('Los valores deben ser mayores a cero');
        return;
      }
      ...
      if (_knowsExactDates) {
        ...
        if (days == 0 && months == 0 && years == 0) {
          _showErrorSnackbar('Ingrese un período de tiempo válido');
          return;
        }
      ...
      setState(() {
        _interestRate = _calculator.calculateTasaInteres(
          capital: capital,
          startDate: startDate,
          endDate: endDate,
          vecesporano: veces,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        Icon(Icons.percent, color: textDark),
                        const SizedBox(width: 8),
                        Text(
                          "CALCULAR TASA",
                          style: TextStyle(
